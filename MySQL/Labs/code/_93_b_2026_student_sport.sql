...
CREATE TABLE `student_sport` (
  ...
  KEY `sportGroup_id` (`sportGroup_id`),
  CONSTRAINT `student_sport_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`),
  CONSTRAINT `student_sport_ibfk_2` FOREIGN KEY (`sportGroup_id`) REFERENCES `sportgroups` (`id`)
...
INSERT INTO `student_sport` VALUES (1,1),(2,1),(3,1),(2,2),(3,2),(2,3),(1,4),(2,4),(3,4);
